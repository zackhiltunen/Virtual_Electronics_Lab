...
namespace GitHub.Unity
{
    ...
    public class ExtensionLoader : ScriptableSingleton<ExtensionLoader>
    {
        ...
        private static void Initialize()
        {
            ...
            {
                var scriptPath = System.IO.Path.Combine(Application.dataPath, "Editor" + System.IO.Path.DirectorySeparatorChar + "GitHub.Unity" + System.IO.Path.DirectorySeparatorChar + "EntryPoint.cs");
